...
public class ReportQueryDAO {
    ...
    public static final String PATIENT_SUMMARY_SQL = "select p.first_name, p.last_name, p.gender, p.patient_id, " +
            ...
            "therapy.cp_total_doses, 0 as cumulative_missed_doses, " +
            "treatment.treatment_outcome, therapy.close_date as treatment_closing_date, treatment.pretreatment_result, " +
            "treatment.pretreatment_weight, therapy.patient_age as age, address.village from whp_reports.patient p " +
