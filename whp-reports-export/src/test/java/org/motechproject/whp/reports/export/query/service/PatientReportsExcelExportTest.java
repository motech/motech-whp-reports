...
public class PatientReportsExcelExportTest extends ExcelTest{
    ...
    public void shouldCreateWorkbookForSummaryReport() throws IOException {
        ...
        Workbook workbook = excelExporter.export(PatientReportBuilder.PATIENT_SUMMARY_TEMPLATE_FILE_NAME, params);
    ...
    public void shouldCreateWorkbookForRegistrationsReport() throws IOException {
        ...
        Workbook workbook = excelExporter.export(PatientReportBuilder.PATIENT_REGISTRATIONS_TEMPLATE_FILE_NAME, params);
    ...
    public void shouldCreateWorkbookForTreatmentClosedReport() throws IOException {
        ...
        Workbook workbook = excelExporter.export(PatientReportBuilder.PATIENT_CLOSED_TREATMENT_TEMPLATE_FILE_NAME, params);
