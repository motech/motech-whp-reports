...
public class PatientReportBuilderTest extends BaseUnitTest {
    ...
    public void setUp() {
        ...
        patientReportBuilder = new PatientReportBuilder(reportQueryService, reportBuilder);
    ...
    public void shouldBuildPatientSummaryReport() throws IOException {
        ...
        verify(reportBuilder).build(outputStream, expectedParams, PatientReportBuilder.PATIENT_SUMMARY_TEMPLATE_FILE_NAME);
    }
    ...
    public void shouldBuildPatientRegistrationsReport() throws IOException {
        ...
        verify(reportQueryService).getPatientSummaries(patientReportRequest);
        verify(reportBuilder).build(outputStream, expectedParams, PatientReportBuilder.PATIENT_REGISTRATIONS_TEMPLATE_FILE_NAME);
    }
    ...
    public void shouldBuildPatientClosedTreatmentReport() throws IOException {
        ...
        verify(reportQueryService).getPatientSummaries(patientReportRequest);
        verify(reportBuilder).build(outputStream, expectedParams, PatientReportBuilder.PATIENT_CLOSED_TREATMENT_TEMPLATE_FILE_NAME);
    }
