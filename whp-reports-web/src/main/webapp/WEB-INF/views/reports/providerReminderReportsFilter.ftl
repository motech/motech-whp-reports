...
<h1>Provider Reminder Call Logs Report</h1>
<form name="providerReminderCallLogsReportsFilter">
    ...
    $(function () {
       ...
       $("#district").combobox();
        ...
        $('#download').bind('click', function (event) {
            ...
            window.open("providerreports/providerReminderCallLogReport.xls" + "?" + $("#district, #from, #to").serialize());
            return false;
        });
    });
</script>
