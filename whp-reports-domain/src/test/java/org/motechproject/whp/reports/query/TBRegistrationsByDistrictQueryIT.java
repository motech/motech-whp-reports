...
public class TBRegistrationsByDistrictQueryIT extends IntegrationTest{
    ...
    public void shouldGetCountOfTBRegistrations() {
        ...
        Patient patient1 = new PatientBuilder().withDefaults().withPatientId("patient1").withTbId("tb1").withDistrict("district1")
                .addTreatment(treatment2).withTbId("tb2")
                .build();
        Patient patient2 = new PatientBuilder().withDefaults().withPatientId("patient2").withTbId("tb3").withDistrict("district2").build();
